...
//   node render-demo.js <fps> <outDir> <serverPort>   (serve the REPO ROOT)
import fs from "node:fs";
import path from "node:path";
import puppeteer from "puppeteer-core";
const CHROME = process.env.CHROME_PATH || "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome";
const [, , fpsArg, outDir, portArg] = process.argv;
...
await page.goto(`http://localhost:${port}/tools/demo-practice-loop.html`, { waitUntil: "networkidle0" });
